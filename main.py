...
playlist_id = createPlaylist(playlist_title, 'Created with \'Spotify Playlist To Youtube\' https://github.com/rasmus-ob/spotify-to-youtube')
...
for i, song in enumerate(no_duplicates_songs):
    ...
    print('Added: ' + full_link + ' to playlist')
